...
const journey: RouteStop[] = [
  {
    ...
    organization: 'FIRSTSOURCE SOLUTIONS PVT. LTD.',
    description: 'Engineered backend AI services and MCP server tools for enterprise platforms including MCI, Disability Copilot, ETS Entity Module, IVR Automation (AWS Connect), and QC Auditor. Also contributed to Token Cost Estimation, AI document auditing agents, and designed N8N production workflows.',
  },
  {
    id: '02',
    year: 'JUN 2024 - JUL 2024',
    title: 'WEB DEVELOPMENT INTERN',
    organization: 'THE HACKETT GROUP PVT. LTD.',
    description: 'Contributed to enterprise web development tasks, supporting consulting deliverables using modern frontend technologies.',
  },
  {
    id: '03',
    ...
    description: 'Built and delivered multiple professional client websites using WordPress. Specialized in custom themes, performance optimisation, and responsive design for diverse client requirements.',
  },
  {
    id: '04',
    year: '2021 - 2025',
    title: 'B.TECH IN CSE (8.85 CGPA)',
    organization: 'VELLORE INSTITUTE OF TECHNOLOGY',
    description: 'Bachelor of Technology in Computer Science Engineering. Secured Rank 103 in VITEEE entrance examination 2021, awarded a 25% scholarship seat waiver.',
  },
  {
    id: '05',
    year: '2019 - 2021',
    title: 'HIGHER SECONDARY (MPC) - 95.7%',
    organization: 'SRI CHAITANYA JUNIOR COLLEGE',
    description: 'Completed specialized coursework in Mathematics, Physics, and Chemistry with 95.7% aggregate excellence.',
  },
  {
    id: '06',
    year: '2019',
    title: 'SECONDARY SCHOOL (SSC) - 10/10 CGPA',
    organization: 'OXFORD CONCEPT SCHOOL',
    description: 'Completed secondary schooling with a perfect 10/10 CGPA.',
  },
];
