...
const RESUME_PATH = '/resume/Bodlapati_Jaswanth_Reddy_Resume.pdf';
...
export const ContactSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Trigger automatic resume download
    const link = document.createElement('a');
    link.href = RESUME_PATH;
    link.download = 'Bodlapati_Jaswanth_Reddy_Resume.pdf';
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Enter your name, email, and phone number below to instantly download my complete resume — detailing my experience at Firstsource Solutions, engineering projects, and technical skill set.
              </p>
            </div>
          </div>
            ...
            {sent ? (
              <div className="py-16 text-center space-y-4">
                ...
                <p className="text-xs text-[#A8988B] font-light" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                  Thank you, {formData.name.split(' ')[0] || 'friend'}. Your download should begin automatically.
                </p>
              </div>
            ) : (
        ...
        <div className="pt-16 mt-16 border-t border-[#8C6D4F]/15 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4">
          <span className="text-[10px] font-mono tracking-widest text-[#8C6D4F] uppercase">
            BODLAPATI JASWANTH REDDY // PORTFOLIO 2026
          </span>
