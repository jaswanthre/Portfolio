...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['React.js', 'HTML', 'CSS', 'Material-UI', 'Chart.js', 'Responsive Design'],
    description: 'Building high-performance, responsive web interfaces with modern React ecosystems, Material-UI component libraries, and interactive data visualisation with Chart.js.',
    stat: '100% RESPONSIVE',
  ...
  },
  {
    ...
    items: ['Node.js', 'Express.js', 'FastAPI', 'REST APIs', 'JWT', 'Docker'],
    description: 'Engineering RESTful APIs, JWT-based authentication, containerized microservices, and scalable backend architectures for enterprise platforms.',
    stat: 'PRODUCTION GRADE',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'DATABASES & CLOUD',
    badge: 'PERSISTENCE & DEPLOY',
    items: ['MongoDB', 'PostgreSQL', 'MySQL', 'AWS S3', 'AWS Lambda', 'Azure App Services'],
    description: 'Designing resilient relational and document schemas with cloud deployments on AWS and Azure, CI/CD pipelines via GitHub Actions.',
    stat: 'AWS & AZURE',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'AI & AUTOMATION',
    badge: 'INTELLIGENCE',
    items: ['LLM Integration', 'Prompt Engineering', 'N8N Workflows', 'AWS Connect', 'AI Agents', 'Python'],
    description: 'Building enterprise AI agents, LLM-powered automation pipelines, IVR solutions with AWS Connect, and production-grade N8N workflow automations integrating APIs, databases, and AI services.',
    stat: '6+ AI AGENTS',
    colSpan: 'lg:col-span-7',
  },
];
