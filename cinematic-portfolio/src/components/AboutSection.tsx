...
export const AboutSection: React.FC = () => {
  ...
  // Replay the video from the start every time the About section enters view
  useEffect(() => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Jaswanth Reddy</span>, a Software Engineer specializing in AI & Automation, building enterprise backend services, LLM-powered agents, and scalable full-stack platforms. With experience at Firstsource Solutions engineering production AI systems, I turn complex requirements into impactful, automated solutions.
            </motion.p>
          ...
          <div className="lg:col-span-5 flex items-center justify-end relative perspective-[1400px]">
            ...
            <motion.div
              ...
              className="relative w-full max-w-[560px] p-3.5 border border-[#8C6D4F]/40 rounded-sm bg-[#120F0C]/80 shadow-[0_25px_70px_rgba(0,0,0,0.95)] cursor-pointer group transition-colors duration-500 hover:border-[#D4AF37]/80"
            >
              ...
              <div className="relative overflow-hidden w-full aspect-[4/3] bg-black rounded-sm">
                {/* Main Portrait Video */}
                <video
                  ref={videoRef}
                  autoPlay
